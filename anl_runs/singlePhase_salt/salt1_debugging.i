...
# ⭐⭐ Today editing: 3 Junio 2025
# 
# 
#                             SALT 1 SAM - Debugging
#--> Will run for a long time; potentially forever. 
# Next step is to use higher quadrature order and then add heat exchanger
# 
# Building on Ex06 salt loop. Look at Dr. Mui's ORNL Flinak Corrosion for more guidance
# 
## Overview questions
...
[Postprocessors] # Will need to fix all of these... 
  ...
  [1_salt_loss]                                  # Temperature at inlet of TP6
    type = ComponentBoundaryVariableValue
    variable = velocity
    input = pipe5(out)
  []
...
[Executioner] # Creating timestepper
  ...
  [Quadrature]
    type =  TRAP # GAUSS # Sometimes we do Trap and first order, 
