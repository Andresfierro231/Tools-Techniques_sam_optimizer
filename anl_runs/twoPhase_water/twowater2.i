...
target_bubble_d_eq  := 0.004
target_gas_vel      := 0.2483
target_void_frac    := 0.009


We_exp := 4.390 # 3.58 # 3.58 # 
injection_vol_rate := ${fparse 4.9e-7}
...
T_h :=  321 # 324 # 324 # # Turns out simulation stability is incredibly sensitive to value chosen here, but not numerical result for some strange reason # Maybe not highest temp, but avg temp of loop?
