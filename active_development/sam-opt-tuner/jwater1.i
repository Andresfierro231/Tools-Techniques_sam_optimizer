...
T_h := 313  # Turns out simulation stability is incredibly sensitive to value chosen here, but not numerical result for some strange reason # Maybe not highest temp, but avg temp of loop? 
p_0 := 1.1e5 # 1.01e5 # try change to 1.5 or 2 # Initial pressure, and ambient
T_0 := 313 # T_0 := T_c # 441.37 # 430 # Kelvin # Initial System, start a bit warmer than T_c
