...
T_h := 480.0   # Turns out simulation stability is incredibly sensitive to value chosen here, but not numerical result for some strange reason # Maybe not highest temp, but avg temp of loop? 
T_0 := 473.0   # T_0 := 473.0 # 441.37 # 430 # Kelvin # Initial System, start a bit warmer than T_c
